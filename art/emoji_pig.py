...
def pig():
  ...
  <g id="s-eyeL"><ellipse id="s-scleraL" cx="228" cy="258" rx="22" ry="25" fill="#fff" opacity="0"/><g id="s-pupilL"><ellipse cx="228" cy="258" rx="16" ry="19" fill="#2a1420"/><circle cx="223" cy="251" r="5" fill="#fff" opacity=".9"/><circle cx="233" cy="264" r="2.5" fill="#fff" opacity="0" class="s-spark"/></g><path class="s-happy" d="M 210 264 Q 228 238 246 264" fill="none" stroke="#2a1420" stroke-width="7" stroke-linecap="round" opacity="0"/><path class="s-brow" d="M 204 232 L 246 222" fill="none" stroke="#7a2448" stroke-width="6" stroke-linecap="round" opacity="0"/><ellipse id="s-tear" cx="242" cy="284" rx="7" ry="9" fill="#bfe0ff" stroke="#8fb7dc" stroke-width="1.5" opacity="0"/></g>
  <g id="s-eyeR"><ellipse id="s-scleraR" cx="372" cy="258" rx="22" ry="25" fill="#fff" opacity="0"/><g id="s-pupilR"><ellipse cx="372" cy="258" rx="16" ry="19" fill="#2a1420"/><circle cx="367" cy="251" r="5" fill="#fff" opacity=".9"/><circle cx="377" cy="264" r="2.5" fill="#fff" opacity="0" class="s-spark"/></g><path class="s-happy" d="M 354 264 Q 372 238 390 264" fill="none" stroke="#2a1420" stroke-width="7" stroke-linecap="round" opacity="0"/><path class="s-brow" d="M 396 232 L 354 222" fill="none" stroke="#7a2448" stroke-width="6" stroke-linecap="round" opacity="0"/></g>
  <g id="s-mud">
